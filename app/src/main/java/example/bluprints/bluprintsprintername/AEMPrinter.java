...
public class AEMPrinter 
{
	...
	public static final byte FONT_NORMAL = 0X06; //normal font
	...
	public void printBarcode(String barcodeData, BARCODE_TYPE barcodetype, BARCODE_HEIGHT barcodeheight) throws IOException
{
	...
	public void printImage(Bitmap originalBitmap) throws IOException
	{
		
		PrintRasterImage PrintRasterImage = new PrintRasterImage(getResizedBitmap(originalBitmap));
		PrintRasterImage.PrepareImage(example.bluprints.bluprintsprintername.PrintRasterImage.dither.floyd_steinberg, 128);
